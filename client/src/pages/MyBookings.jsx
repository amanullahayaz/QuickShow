...
const MyBookings = () => {
  ...
  return !isLoading ? (
    <div className='relative p-6 md:px-16 lf:px-40 pt-30 md:pt-40 min-h-[80vh]'>
      <BlurCircle top="100px" left="100px" />
      <div>
        <BlurCircle bottom="0px" left="600px" />
      </div>

      <h1 className='test-lg font-semibold mb-4'>My Bookings</h1>
      {bookings.filter(b => b.show).map((item, index) => (
        <div key={index} className='flex flex-col md:flex-row justify-between bg-primary/8 border border-primary/20 rounded-lg mt-4 p-2 max-w-3xl'>
          ...
          <div className='flex flex-col md:items-end md:text-right justofy-between p-4'>
